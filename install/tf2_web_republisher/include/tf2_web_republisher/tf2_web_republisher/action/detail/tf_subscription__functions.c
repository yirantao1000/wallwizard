  ...
  tf2_web_republisher__action__TFSubscription_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_web_republisher__action__TFSubscription_Goal * data =
      (tf2_web_republisher__action__TFSubscription_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_web_republisher__action__TFSubscription_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tf2_web_republisher__action__TFSubscription_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  tf2_web_republisher__action__TFSubscription_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_web_republisher__action__TFSubscription_Result * data =
      (tf2_web_republisher__action__TFSubscription_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_web_republisher__action__TFSubscription_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tf2_web_republisher__action__TFSubscription_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  tf2_web_republisher__action__TFSubscription_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_web_republisher__action__TFSubscription_Feedback * data =
      (tf2_web_republisher__action__TFSubscription_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_web_republisher__action__TFSubscription_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tf2_web_republisher__action__TFSubscription_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  tf2_web_republisher__action__TFSubscription_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_web_republisher__action__TFSubscription_SendGoal_Request * data =
      (tf2_web_republisher__action__TFSubscription_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_web_republisher__action__TFSubscription_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tf2_web_republisher__action__TFSubscription_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  tf2_web_republisher__action__TFSubscription_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_web_republisher__action__TFSubscription_SendGoal_Response * data =
      (tf2_web_republisher__action__TFSubscription_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_web_republisher__action__TFSubscription_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tf2_web_republisher__action__TFSubscription_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  tf2_web_republisher__action__TFSubscription_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_web_republisher__action__TFSubscription_GetResult_Request * data =
      (tf2_web_republisher__action__TFSubscription_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_web_republisher__action__TFSubscription_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tf2_web_republisher__action__TFSubscription_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  tf2_web_republisher__action__TFSubscription_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_web_republisher__action__TFSubscription_GetResult_Response * data =
      (tf2_web_republisher__action__TFSubscription_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_web_republisher__action__TFSubscription_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tf2_web_republisher__action__TFSubscription_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  tf2_web_republisher__action__TFSubscription_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_web_republisher__action__TFSubscription_FeedbackMessage * data =
      (tf2_web_republisher__action__TFSubscription_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_web_republisher__action__TFSubscription_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tf2_web_republisher__action__TFSubscription_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
