  ...
  tf2_web_republisher__srv__RepublishTFs_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_web_republisher__srv__RepublishTFs_Request * data =
      (tf2_web_republisher__srv__RepublishTFs_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_web_republisher__srv__RepublishTFs_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tf2_web_republisher__srv__RepublishTFs_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  tf2_web_republisher__srv__RepublishTFs_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tf2_web_republisher__srv__RepublishTFs_Response * data =
      (tf2_web_republisher__srv__RepublishTFs_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_web_republisher__srv__RepublishTFs_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tf2_web_republisher__srv__RepublishTFs_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
