...
bool speech_recognition_msgs__msg__speech_recognition_candidates__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("speech_recognition_msgs.msg._speech_recognition_candidates.SpeechRecognitionCandidates", full_classname_dest, 86) == 0);
  }
  speech_recognition_msgs__msg__SpeechRecognitionCandidates * ros_message = _ros_message;
  {  // transcript
    ...
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'transcript'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->transcript.data;
...
{
  /* NOTE(esteve): Call constructor of SpeechRecognitionCandidates */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("speech_recognition_msgs.msg._speech_recognition_candidates");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SpeechRecognitionCandidates");
  ...
  {  // transcript
    ...
    rosidl_runtime_c__String * src = ros_message->transcript.data;
