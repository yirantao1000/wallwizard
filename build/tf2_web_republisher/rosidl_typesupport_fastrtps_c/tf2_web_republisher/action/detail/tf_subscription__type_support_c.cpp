  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tf2_web_republisher__action__TFSubscription_Goal;
    is_plain =
      (
...
static size_t _TFSubscription_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tf2_web_republisher__action__TFSubscription_Goal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tf2_web_republisher__action__TFSubscription_Result;
    is_plain =
      (
...
static size_t _TFSubscription_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tf2_web_republisher__action__TFSubscription_Result(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tf2_web_republisher__action__TFSubscription_Feedback;
    is_plain =
      (
...
static size_t _TFSubscription_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tf2_web_republisher__action__TFSubscription_Feedback(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tf2_web_republisher__action__TFSubscription_SendGoal_Request;
    is_plain =
      (
...
static size_t _TFSubscription_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tf2_web_republisher__action__TFSubscription_SendGoal_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tf2_web_republisher__action__TFSubscription_SendGoal_Response;
    is_plain =
      (
...
static size_t _TFSubscription_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tf2_web_republisher__action__TFSubscription_SendGoal_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tf2_web_republisher__action__TFSubscription_GetResult_Request;
    is_plain =
      (
...
static size_t _TFSubscription_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tf2_web_republisher__action__TFSubscription_GetResult_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tf2_web_republisher__action__TFSubscription_GetResult_Response;
    is_plain =
      (
...
static size_t _TFSubscription_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tf2_web_republisher__action__TFSubscription_GetResult_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tf2_web_republisher__action__TFSubscription_FeedbackMessage;
    is_plain =
      (
...
static size_t _TFSubscription_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tf2_web_republisher__action__TFSubscription_FeedbackMessage(
    full_bounded, is_plain, 0);
