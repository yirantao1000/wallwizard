  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tf2_web_republisher__srv__RepublishTFs_Request;
    is_plain =
      (
...
static size_t _RepublishTFs_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tf2_web_republisher__srv__RepublishTFs_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tf2_web_republisher__srv__RepublishTFs_Response;
    is_plain =
      (
...
static size_t _RepublishTFs_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tf2_web_republisher__srv__RepublishTFs_Response(
    full_bounded, is_plain, 0);
