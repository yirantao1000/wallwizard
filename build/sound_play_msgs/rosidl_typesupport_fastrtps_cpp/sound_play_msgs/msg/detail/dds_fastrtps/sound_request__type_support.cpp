...
#include "sound_play_msgs/msg/detail/sound_request__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sound_play_msgs::msg::SoundRequest;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sound_play_msgs::msg::SoundRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sound_play_msgs::msg::SoundRequest *>(
    untyped_ros_message);
...
{
  return &sound_play_msgs::msg::typesupport_fastrtps_cpp::_SoundRequest__handle;
}
