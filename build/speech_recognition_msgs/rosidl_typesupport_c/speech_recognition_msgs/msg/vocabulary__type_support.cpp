...
static const _Vocabulary_type_support_symbol_names_t _Vocabulary_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, speech_recognition_msgs, msg, Vocabulary)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, speech_recognition_msgs, msg, Vocabulary)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, speech_recognition_msgs, msg, Vocabulary)() {
  return &::speech_recognition_msgs::msg::rosidl_typesupport_c::Vocabulary_message_type_support_handle;
}
