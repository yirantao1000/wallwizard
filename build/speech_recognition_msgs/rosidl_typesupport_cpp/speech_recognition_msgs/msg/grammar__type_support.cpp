...
static const _Grammar_type_support_symbol_names_t _Grammar_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, speech_recognition_msgs, msg, Grammar)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, speech_recognition_msgs, msg, Grammar)),
  }
};
...
{
  return &::speech_recognition_msgs::msg::rosidl_typesupport_cpp::Grammar_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, speech_recognition_msgs, msg, Grammar)() {
  return get_message_type_support_handle<speech_recognition_msgs::msg::Grammar>();
}
